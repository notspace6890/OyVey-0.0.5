            ...
            if (HUD.getInstance().renderingMode.getValue() == HUD.RenderingMode.Length) {
                for (final Module module : ModuleManager.this.sortedModules) {
                    ...
                    if (module.isEnabled() && HUD.getInstance().animationHorizontalTime.getValue() != 1) {
                        ...
                        if (module.arrayListOffset < ModuleManager.this.renderer.getStringWidth(text) && Util.mc.field_71441_e != null) {
                ...
                for (final String e : ModuleManager.this.sortedModulesABC) {
                    ...
                    if (module2.isEnabled() && HUD.getInstance().animationHorizontalTime.getValue() != 1) {
                        if (module2.arrayListOffset <= module2.offset || Util.mc.field_71441_e == null) {
                            continue;
                        }
                        ...
                        if (module2.arrayListOffset < ModuleManager.this.renderer.getStringWidth(text2) && Util.mc.field_71441_e != null) {
