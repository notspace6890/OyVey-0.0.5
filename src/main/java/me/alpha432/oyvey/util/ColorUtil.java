...
public class ColorUtil
{
    ...
    public static Color rainbow(final int delay) {
        ...
        rainbowState %= 360.0;
        return Color.getHSBColor((float)(rainbowState / 360.0), ClickGui.getInstance().rainbowSaturation.getValue() / 255.0f, ClickGui.getInstance().rainbowBrightness.getValue() / 255.0f);
    }
